...
## [v0.5.6](https://github.com/tapihdev/junit-monorepo-go/compare/v0.5.5...v0.5.6) - 2026-05-13
- chore(deps): update tapihdev/tag-major-minor-semver action to v1.0.5 by @renovate[bot] in https://github.com/tapihdev/junit-monorepo-go/pull/164
- chore(deps): update actions/checkout action to v4.2.2 by @renovate[bot] in https://github.com/tapihdev/junit-monorepo-go/pull/165
- chore(deps): update pnpm to v10.11.0 by @renovate[bot] in https://github.com/tapihdev/junit-monorepo-go/pull/167
- chore(deps): update node.js to v22.15.1 by @renovate[bot] in https://github.com/tapihdev/junit-monorepo-go/pull/163
- chore(deps): update dependency yaml to v2.8.3 [security] by @renovate[bot] in https://github.com/tapihdev/junit-monorepo-go/pull/171
...
- chore(deps): lock file maintenance by @renovate in https://github.com/tapihdev/junit-monorepo-go/pull/128
- doc: Update README.md by @tapih in https://github.com/tapihdev/junit-monorepo-go/pull/129
...
- chore(deps): lock file maintenance by @renovate in https://github.com/tapihdev/junit-monorepo-go/pull/86
- chore(deps): lock file maintenance by @renovate in https://github.com/tapihdev/junit-monorepo-go/pull/87
